...
function Student(name, age, fn){
    ...
    // This will be a "private variable" due to the closures using it
    var mark; 
    ...
    // Method using "private variables" can not be added to the prototype
...
// We need show the prototype connection between the objects that we will be creating
...
var ivan = new Student('Ivan', 22, 61999);
console.log(ivan.studentInfo()); // Ivan 22 61999

// We don't have direct access to variables in Student, which are not binded to it's context
//ivan.mark = 5; // Error
ivan.setMark(5);
...
// On calling a prototype's property from the instance of the constructor functio, 
...
// Create instance of Student
var pesho = new Student('Pesho', 20, 61998);
